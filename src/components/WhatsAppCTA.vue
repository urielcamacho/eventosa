...
<template>
  <section id="contacto" ref="root" class="final-cta" aria-labelledby="contact-title">
    <ImagePlaceholder
      class="final-cta__media"
      label="Cierre"
      dimensions="1920 × 1080 px"
      description="Ambiente cálido de una celebración al atardecer."
      ratio="16/9"
      tone="olive"
    />
